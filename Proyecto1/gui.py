...
"""------------------------------------------Buttons------------------------------------------"""
#Start Button
start_button = tk.Button(window, text = 'Start', width = 12, height = 3, command = lambda: window.quit())
...
#Stop Button
stop_button = tk.Button(window, text = 'Stop', width = 12, height = 3, command = lambda: window.quit())
...
#Next Button
next_button = tk.Button(window, text = 'Next', width = 12, height = 3, command = lambda: window.quit())
