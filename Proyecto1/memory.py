class Memory:
            ...
            for i in self.p1_cache:
                if i[1] == address:
                    if i[0] == "M":
                        ...
                        self.change_cache_block_state(1, address, "S")
                    if i[0] == "E":
                        print("P1:B" + str(block) + " Changed to S")
                        self.change_cache_block_state(1, address, "S")
                block = block + 1
            ...
            for i in self.p2_cache:
                if i[1] == address:
                    if i[0] == "M":
                        ...
                        self.change_cache_block_state(2, address, "S")
                    if i[0] == "E":
                        print("P2:B" + str(block) + " Changed to S")
                        self.change_cache_block_state(2, address, "S")
                block = block + 1
            ...
            for i in self.p3_cache:
                if i[1] == address:
                    if i[0] == "M":
                        ...
                        self.change_cache_block_state(3, address, "S")
                    if i[0] == "E":
                        print("P3:B" + str(block) + " Changed to S")
                        self.change_cache_block_state(3, address, "S")
                block = block + 1
            ...
            for i in self.p0_cache:
                if i[1] == address:
                    if i[0] == "M":
                        ...
                        self.change_cache_block_state(0, address, "S")
                    if i[0] == "E":
                        print("P0:B" + str(block) + " Changed to S")
                        self.change_cache_block_state(0, address, "S")
                block = block + 1
    ...
    #Function to modify the state of blocks when an address is being written in another cache
            ...
            for i in self.p1_cache:
                if i[1] == address:
                    if i[0] == "M":
                        print("Write-back on Address " + address)
                        self.write_to_memory(address, i[2])
                        print("P1:B" + str(block) + " Changed to I")
                        self.change_cache_block_state(1, address, "I")
                    if i[0] == "E":
                        print("P1:B" + str(block) + " Changed to I")
                        self.change_cache_block_state(1, address, "I")
                    if i[0] == "S":
            ...
            for i in self.p2_cache:
                if i[1] == address:
                    if i[0] == "M":
                        print("Write-back on Address " + address)
                        self.write_to_memory(address, i[2])
                        print("P2:B" + str(block) + " Changed to I")
                        self.change_cache_block_state(2, address, "I")
                    if i[0] == "E":
                        print("P2:B" + str(block) + " Changed to I")
                        self.change_cache_block_state(2, address, "I")
                block = block + 1
            ...
            for i in self.p3_cache:
                if i[1] == address:
                    if i[0] == "M":
                        print("Write-back on Address " + address)
                        self.write_to_memory(address, i[2])
                        print("P3:B" + str(block) + " Changed to I")
                        self.change_cache_block_state(3, address, "I")
                    if i[0] == "E":
                        print("P3:B" + str(block) + " Changed to I")
                        self.change_cache_block_state(3, address, "I")
                block = block + 1
            ...
            for i in self.p0_cache:
                if i[1] == address:
                    if i[0] == "M":
                        print("Write-back on Address " + address)
                        self.write_to_memory(address, i[2])
                        print("P0:B" + str(block) + " Changed to I")
                        self.change_cache_block_state(0, address, "I")
                    if i[0] == "E":
                        print("P0:B" + str(block) + " Changed to I")
                        self.change_cache_block_state(0, address, "I")
                block = block + 1
